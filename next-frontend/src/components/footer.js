      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-600 max-w-md">
              A decentralized medical storage system leveraging blockchain technology for secure and immutable storage
              of medical records.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link href="/features/storage" className="text-base text-gray-600 hover:text-gray-900">
                  Decentralized Storage
                </Link>
              </li>
              <li>
                <Link href="/features/hospital" className="text-base text-gray-600 hover:text-gray-900">
                  Hospital Integration
                </Link>
              </li>
              <li>
                <Link href="/features/medicine" className="text-base text-gray-600 hover:text-gray-900">
                  Medicine Comparison
                </Link>
              </li>
              <li>
                <Link href="/features/ai" className="text-base text-gray-600 hover:text-gray-900">
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Curelink AI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
